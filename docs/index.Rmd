...
load("C:/Users/philip//OneDrive/NP_Kontrakt/StromTracks/files/allspecies/data/f_allbirds.RData")
f <- f[, -c(18:21)]
...
Using the previous object from the `filt()` function, the `plottingMAP()` function plots each trip, along with the colony and the trip’s locations (*blue = colony; purple = trip locations*). The function use the `basemap()` from the [ggOceanMaps](https://mikkovihtakari.github.io/ggOceanMaps/) package in its pipeline. If mulitple trips are given, the function will make one figure per trip
